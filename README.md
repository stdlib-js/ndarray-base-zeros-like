...
```javascript
zerosLike = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-zeros-like@v0.3.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/ndarray-base-zeros-like/actions/workflows/test.yml/badge.svg?branch=v0.3.1
[test-url]: https://github.com/stdlib-js/ndarray-base-zeros-like/actions/workflows/test.yml?query=branch:v0.3.1
